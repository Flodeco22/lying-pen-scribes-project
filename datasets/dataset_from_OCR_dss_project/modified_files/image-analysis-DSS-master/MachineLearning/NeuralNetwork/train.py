...
def LoadDataset(dataset, device, batch_size):
    ...
    train_images_file = "MachineLearning/NeuralNetwork/datasets/custom_dataset/train-images-idx3-ubyte"
    train_labels_file = "MachineLearning/NeuralNetwork/datasets/custom_dataset/train-labels-idx1-ubyte"
    validation_images_file = "MachineLearning/NeuralNetwork/datasets/custom_dataset/validation-images-idx3-ubyte"
    validation_labels_file = "MachineLearning/NeuralNetwork/datasets/custom_dataset/validation-labels-idx1-ubyte"
